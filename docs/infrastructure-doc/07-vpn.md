...
2. Sign into Open VPN to sign up and create an account.
3. Within IAM Identity Manager, create an application for OpenVPN and configuration with OpenVPN metadata. You can also manage users for Open VPN.
